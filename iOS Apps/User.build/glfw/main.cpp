...
class bb_User_UserApp : public bb_app_App{
	public:
	bb_tcpstream_TcpStream* f_Server;
	bb_User_UserApp();
	bb_User_UserApp* g_new();
	virtual int m_OnCreate();
	virtual int m_OnRender();
	virtual int m_OnUpdate();
	void mark();
...
String dbg_type(bb_User_UserApp**p){return "UserApp";}
...
class bb_page_Page : public Object{
	public:
	bb_page_Page();
...
String dbg_type(bb_page_Page**p){return "Page";}
extern bb_page_Page* bb_page_CUR_PAGE;
...
class bb_page_SplashPage : public bb_page_Page{
	public:
	bb_challengergui_CHGUI* f_Title;
	bb_challengergui_CHGUI* f_Login;
	bb_challengergui_CHGUI* f_LoginFB;
	bb_challengergui_CHGUI* f_NewAccount;
	bb_page_SplashPage();
	bb_page_SplashPage* g_new();
	virtual int m_Render();
	virtual int m_Clear();
	virtual int m_Update();
	void mark();
...
String dbg_type(bb_page_SplashPage**p){return "SplashPage";}
...
class bb_page_CreateAccountPage : public bb_page_Page{
	public:
	bb_challengergui_CHGUI* f_Title;
	bb_challengergui_CHGUI* f_FirstName;
	bb_challengergui_CHGUI* f_LastName;
	bb_challengergui_CHGUI* f_Username;
	bb_challengergui_CHGUI* f_Pw;
	bb_challengergui_CHGUI* f_Interests;
	bb_challengergui_CHGUI* f_T_FN;
	bb_challengergui_CHGUI* f_T_LN;
	bb_challengergui_CHGUI* f_T_UN;
	bb_challengergui_CHGUI* f_T_PW;
	bb_challengergui_CHGUI* f_T_I;
	bb_challengergui_CHGUI* f_Start;
	bb_page_CreateAccountPage();
	bb_page_CreateAccountPage* g_new();
	virtual int m_Render();
	virtual int m_Update();
	void mark();
	String debug();
...
bb_User_UserApp::bb_User_UserApp(){
	f_Server=0;
}
bb_User_UserApp* bb_User_UserApp::g_new(){
	DBG_ENTER("UserApp.new")
	bb_User_UserApp *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<3>");
	bb_app_App::g_new();
	return this;
}
int bb_User_UserApp::m_OnCreate(){
	DBG_ENTER("UserApp.OnCreate")
	bb_User_UserApp *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<9>");
	bb_challengergui_CHGUI_MobileMode=1;
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<10>");
	bb_app_SetUpdateRate(30);
	return 0;
}
int bb_User_UserApp::m_OnRender(){
	DBG_ENTER("UserApp.OnRender")
	bb_User_UserApp *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<14>");
	String t_=bb_data2_STATUS;
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<15>");
	if(t_==String(L"connecting",10)){
		DBG_BLOCK();
		DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<16>");
		if(f_Server->m_Connect(String(L"www.fuzzit.us",13),80)){
			DBG_BLOCK();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<17>");
			bb_data2_STATUS=String(L"normal",6);
		}
	}else{
		DBG_BLOCK();
		DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<19>");
		if(t_==String(L"normal",6)){
			DBG_BLOCK();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<20>");
			bb_graphics_Cls(FLOAT(247.0),FLOAT(247.0),FLOAT(247.0));
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<21>");
			bb_page_CUR_PAGE->m_Render();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<22>");
			bb_challengergui_CHGUI_Draw();
		}else{
			DBG_BLOCK();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<23>");
			if(t_==String(L"start",5)){
				DBG_BLOCK();
				DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<24>");
				gc_assign(f_Server,(new bb_tcpstream_TcpStream)->g_new());
				DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<25>");
				gc_assign(bb_page_CUR_PAGE,((new bb_page_SplashPage)->g_new()));
				DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<26>");
...
int bb_User_UserApp::m_OnUpdate(){
	DBG_ENTER("UserApp.OnUpdate")
	bb_User_UserApp *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<31>");
	String t_=bb_data2_STATUS;
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<32>");
	if(t_==String(L"connecting",10)){
		DBG_BLOCK();
	}else{
		DBG_BLOCK();
		DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<33>");
		if(t_==String(L"normal",6)){
			DBG_BLOCK();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<34>");
			bb_page_CUR_PAGE->m_Update();
			DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<35>");
			bb_challengergui_CHGUI_Update();
		}
	}
	return 0;
}
void bb_User_UserApp::mark(){
	bb_app_App::mark();
	gc_mark_q(f_Server);
}
String bb_User_UserApp::debug(){
	String t="(UserApp)\n";
...
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/User.monkey<42>");
	(new bb_User_UserApp)->g_new();
	return 0;
}
...
bb_page_Page::bb_page_Page(){
}
int bb_page_Page::m_Render(){
	DBG_ENTER("Page.Render")
	bb_page_Page *self=this;
	DBG_LOCAL(self,"Self")
	return 0;
}
bb_page_Page* bb_page_Page::g_new(){
	DBG_ENTER("Page.new")
	bb_page_Page *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<5>");
	return this;
}
int bb_page_Page::m_Update(){
	DBG_ENTER("Page.Update")
	bb_page_Page *self=this;
	DBG_LOCAL(self,"Self")
	return 0;
}
int bb_page_Page::m_Clear(){
	DBG_ENTER("Page.Clear")
	bb_page_Page *self=this;
	DBG_LOCAL(self,"Self")
	return 0;
}
void bb_page_Page::mark(){
	Object::mark();
}
String bb_page_Page::debug(){
	String t="(Page)\n";
	return t;
}
bb_page_Page* bb_page_CUR_PAGE;
...
bb_page_SplashPage::bb_page_SplashPage(){
	f_Title=0;
	f_Login=0;
	f_LoginFB=0;
	f_NewAccount=0;
}
bb_page_SplashPage* bb_page_SplashPage::g_new(){
	DBG_ENTER("SplashPage.new")
	bb_page_SplashPage *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<19>");
	bb_page_Page::g_new();
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<20>");
	gc_assign(f_Title,bb_data2_CScale(bb_challengergui_CreateLabel(80,10,String(L"Beacon Demo",11),0)));
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<21>");
	gc_assign(f_Login,bb_data2_CScale(bb_challengergui_CreateButton(20,100,int(bb_data2_SCALE_W-FLOAT(40.0)),50,String(L"Login",5),0)));
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<22>");
	gc_assign(f_LoginFB,bb_data2_CScale(bb_challengergui_CreateButton(20,160,int(bb_data2_SCALE_W-FLOAT(40.0)),50,String(L"Facebook Login",14),0)));
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<23>");
	gc_assign(f_NewAccount,bb_data2_CScale(bb_challengergui_CreateButton(20,220,int(bb_data2_SCALE_W-FLOAT(40.0)),50,String(L"Create A New Account",20),0)));
	return this;
}
int bb_page_SplashPage::m_Render(){
	DBG_ENTER("SplashPage.Render")
	bb_page_SplashPage *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<26>");
	bb_challengergui_CHGUI_Draw();
	return 0;
}
int bb_page_SplashPage::m_Clear(){
...
int bb_page_SplashPage::m_Update(){
	DBG_ENTER("SplashPage.Update")
	bb_page_SplashPage *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<29>");
	bb_challengergui_CHGUI_Update();
	DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<30>");
	if((f_NewAccount->f_Clicked)!=0){
		DBG_BLOCK();
		DBG_INFO("J:/WORK/Fuzzit/iOS Beacon Demo/repo/wurtland/iOS Apps/page.monkey<31>");
		m_Clear();
...
void bb_page_SplashPage::mark(){
	bb_page_Page::mark();
	gc_mark_q(f_Title);
	gc_mark_q(f_Login);
	gc_mark_q(f_LoginFB);
	gc_mark_q(f_NewAccount);
}
String bb_page_SplashPage::debug(){
	String t="(SplashPage)\n";
	t=bb_page_Page::debug()+t;
	t+=dbg_decl("Title",&f_Title);
	t+=dbg_decl("Login",&f_Login);
	t+=dbg_decl("LoginFB",&f_LoginFB);
	t+=dbg_decl("NewAccount",&f_NewAccount);
	return t;
}
...
bb_page_CreateAccountPage::bb_page_CreateAccountPage(){
	f_Title=0;
	f_FirstName=0;
	f_LastName=0;
	f_Username=0;
...
bb_page_CreateAccountPage* bb_page_CreateAccountPage::g_new(){
...
int bb_page_CreateAccountPage::m_Render(){
...
int bb_page_CreateAccountPage::m_Update(){
...
void bb_page_CreateAccountPage::mark(){
	bb_page_Page::mark();
	gc_mark_q(f_Title);
	gc_mark_q(f_FirstName);
	gc_mark_q(f_LastName);
	gc_mark_q(f_Username);
	gc_mark_q(f_Pw);
	gc_mark_q(f_Interests);
	gc_mark_q(f_T_FN);
	gc_mark_q(f_T_LN);
	gc_mark_q(f_T_UN);
	gc_mark_q(f_T_PW);
...
String bb_page_CreateAccountPage::debug(){
	String t="(CreateAccountPage)\n";
	t=bb_page_Page::debug()+t;
	t+=dbg_decl("Title",&f_Title);
	t+=dbg_decl("FirstName",&f_FirstName);
	t+=dbg_decl("T_FN",&f_T_FN);
	t+=dbg_decl("LastName",&f_LastName);
	t+=dbg_decl("T_LN",&f_T_LN);
	t+=dbg_decl("Username",&f_Username);
	t+=dbg_decl("T_UN",&f_T_UN);
	t+=dbg_decl("Pw",&f_Pw);
	t+=dbg_decl("T_PW",&f_T_PW);
	t+=dbg_decl("Interests",&f_Interests);
	t+=dbg_decl("T_I",&f_T_I);
	t+=dbg_decl("Start",&f_Start);
	return t;
}
...
int bbInit(){
	...
	bb_page_CUR_PAGE=0;
	DBG_GLOBAL("CUR_PAGE",&bb_page_CUR_PAGE);
